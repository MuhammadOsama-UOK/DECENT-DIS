      ...
      <AnimatePresence>
        {successLead && (
          <div className="fixed inset-0 z-[500] flex items-center justify-center p-6">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.9, y: 20 }} className="bg-white rounded-[40px] p-10 md:p-12 max-w-lg w-full relative shadow-2xl overflow-hidden text-center">
              ...
              <h3 className="text-3xl font-black text-gray-900 mb-4 uppercase tracking-tighter">Success!</h3>
              <p className="text-gray-600 mb-10 leading-relaxed font-medium">Thank you for contacting Decent Disposal. Our team will contact you within 24 hours.</p>
              <button onClick={handleWhatsAppChat} className="w-full bg-whatsapp text-white py-5 rounded-2xl flex items-center justify-center gap-3 font-bold uppercase tracking-widest hover:opacity-90 shadow-xl"><MessageCircle className="w-6 h-6" />Chat on WhatsApp</button>
            </motion.div>
          </div>
        )}
      </AnimatePresence>
